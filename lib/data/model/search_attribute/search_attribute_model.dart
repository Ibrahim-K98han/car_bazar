...
class SearchAttributeModel extends Equatable {
  ...
  factory SearchAttributeModel.fromMap(Map<String, dynamic> map) {
    return SearchAttributeModel(
      ...
      condition:
          map['conditions'] != null
              ? List<String?>.from((map['conditions'] as List<dynamic>))
              : null,
      purposes:
          map['purposes'] != null
              ? List<String?>.from((map['purposes'] as List<dynamic>))
              : null,
      country:
          map['countries'] != null
      ...
      features:
          map['features'] != null
              ? List<Features>.from(
                (map['features'] as List<dynamic>).map<Features?>(
  ...
  factory SearchAttributeModel.fromJson(String source) =>
      SearchAttributeModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  List<Object> get props {
    return [brands!, condition!, purposes!, country!, features!];
  }
}
...
class CountryModel extends Equatable {
  ...
  factory CountryModel.fromMap(Map<String, dynamic> map) {
    return CountryModel(
      ...
      updatedAt: map['updatedAt'] ?? '',
      totalListing:
          map['total_listing'] != null
              ? int.parse(map['total_listing'].toString())
              : 0,
    );
  }
  ...
  @override
  List<Object> get props {
    return [id, name, code, createdAt, updatedAt, totalListing];
  }
}
...
class CityModel extends Equatable {
  ...
  CityModel copyWith({List<Cities>? cities}) {
    return CityModel(cities: cities ?? this.cities);
  }

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'cities': cities?.map((x) => x.toMap()).toList()};
  }
